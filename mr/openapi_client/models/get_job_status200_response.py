...
class GetJobStatus200Response(BaseModel):
    ...
    __properties: ClassVar[List[str]] = ["job_id", "status", "progress"]
    ...
    def status_validate_enum(cls, value):
        ...
        if value not in set(['submitted', 'running', 'completed', 'failed']):
            raise ValueError("must be one of enum values ('submitted', 'running', 'completed', 'failed')")
        return value
